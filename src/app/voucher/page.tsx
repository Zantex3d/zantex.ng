...
export default function VoucherPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(`Hi ${fullName}, Redirecting to payment gateway for ${plans.find(p => p.id === selectedPlan)?.name}`);
  };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                >
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button 
                            type="submit"
                            className="w-full bg-[#2f455c] text-[#34f5c6] py-5 rounded-2xl font-black text-lg flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-95 transition-all shadow-xl shadow-[#2f455c]/20"
                        >
                            Proceed to Payment
        ...
        <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-slate-500 text-xs font-medium leading-relaxed">Enable Wi-Fi on your device and select the "Zantex Smart Wi-Fi" network.</p>
                </div>
                <div className="space-y-4">
